...
%% 4) Vehicle Dynamics, Buoyancy & Drag
mass       = 20;
added_mass = diag([5,5,10,1,1,1]);
M          = mass*eye(6) + added_mass;

g     = 9.81; rho = 1000;
Vdisp = mass / rho; W = mass*g; Fb = rho*Vdisp*g;
